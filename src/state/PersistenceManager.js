...
export class PersistenceManager {
    ...
    async saveDesignSystem(systemId, systemInfo) {
        try {
    ...
    async saveValidationOptions(options) {
        try {
    ...
    async saveResultsData(resultsData) {
        try {
    ...
    async loadResultsData() {
        try {
            ...
            if (!data)
                return null;
            return Object.assign(Object.assign({}, data), { timestamp: new Date(data.timestamp) });
        }
        catch (error) {
